...
def chatbot_response(user_message: str) -> str:
    ...
    # -------------
        ...
        🌐 <b>Facebook Page:</b> <a href='https://www.facebook.com/share/1A5geiVzcv/' target='_blank' style='color:#003366; font-weight:italic;'>Bangui Institute of Technology TESDA</a><br>
