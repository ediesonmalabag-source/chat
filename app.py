...
def fill_pdf(input_pdf_path, output_pdf_path, data_dict):
    try:
        ...
        for page_index, page in enumerate(template_pdf.pages):
            ...
            # Draw empty circles
            can.circle(35, 348, 4, stroke=1, fill=0)  # Male
            can.circle(35, 340, 4, stroke=1, fill=0)  # Female

            # Fill selected circle
            if data_dict.get("Sex") == "Male":
                can.circle(35, 348, 3, stroke=0, fill=1)
            elif data_dict.get("Sex") == "Female":
                can.circle(35, 340, 3, stroke=0, fill=1)
