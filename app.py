...
def chatbot_response(user_message: str) -> str:
    ...
    # -------------
        ...
        💬 <b>Messenger Chat:</b> <a href='https://m.me/BanguiInstituteofTechnologyTESDA' target='_blank' style='color:#003366; font-weight:italic;'>Message us on Messenger</a><br>
