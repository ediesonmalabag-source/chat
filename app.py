...
def chatbot_response(user_message: str) -> str:
    ...
    # -------------
        ...
        💬 <b>Messenger Chat:</b> <a href='https://www.facebook.com/messages/t/61561653118631' target='_blank' style='color:#003366; font-weight:italic;'>Send a message via Messenger</a><br>
