...
def chatbot_response(user_message: str) -> str:
    ...
    if user_message in ["hi", "hello", "hey", "haha"]:
        return "🤖 Welcome to TESDA BIT Chatbot. For enrolment or assessment inquiries, use the quick action buttons or type your question."
...
if "messages" not in st.session_state:
    ...
    st.session_state.messages = [("Bot", "🤖 Welcome to TESDA BIT Chatbot. For enrolment or assessment inquiries, use the quick action buttons or type your question.")]
